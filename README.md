# BotBrowser-NoStealer

This is a fork of SillyTavern-BotBrowser with the stealer removed, as of now, no other changes have been made (asides from the readme being replaced with this)

# ORIGINAL README (with updated URLS to point to the NoStealer version):
...
```
https://github.com/infdevv/BotBrowser-NoStealer
```
